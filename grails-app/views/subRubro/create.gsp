...
<html>
	...
	<body>
		<a href="#create-subRubro" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-subRubro" class="content scaffold-create" role="main">
			...
			<g:form autocomplete="off" url="[resource:subRubroInstance, action:'save']" >
				<fieldset class="form">
